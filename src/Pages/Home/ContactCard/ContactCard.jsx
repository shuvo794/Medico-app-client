...
const ContactCard = () => {
    return (
        <div  className="container mx-auto my-28 flex  flex-wrap flex-col gap-8 md:flex-row justify-between text-white">
            <div data-aos="zoom-in"  className="md:w-1/3 mx-2 py-4 md:py-0 h-[202px] flex-1 bg-teal-950 rounded-[10px] flex justify-center items-center gap-8" >
            ...
            <div data-aos="zoom-in" className="md:w-1/3 mx-2 py-4 md:py-0 h-[202px]  flex-1 bg-orange-300 rounded-[10px] flex justify-center items-center gap-8" >
